...
if(USE_ASAN OR USE_LSAN OR USE_TSAN)
  ...
  if(USE_ASAN)
    if(TARGET Sanitizer::address)
      ...
      # Expose USE_ASAN as a preprocessor define so source-side gates
      # (e.g. the ROCm + ASAN jiterator disable in
      # aten/src/ATen/jit_macros.h) can see it.
...
if(USE_ROCM)
  ...
  if(PYTORCH_FOUND_HIP)
    ...
    # add_definitions(-DUSE_ASAN) above doesn't reliably propagate to HIP
    # TUs; mirror the pattern used for USE_ROCM and add it explicitly so
    # the source-side gate in aten/src/ATen/jit_macros.h fires under
    # hipified .cu/.cuh TUs.
    if(USE_ASAN)
      list(APPEND HIP_CXX_FLAGS -DUSE_ASAN)
    endif()
